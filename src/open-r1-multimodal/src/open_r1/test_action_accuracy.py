...
from open_r1.test_action_accuracy_zeroshot import ResultEntry
...
def run(args):
    ...
    if args.action_mapping == 'ab':
        pass  # default mapping
    elif args.action_mapping == 'ba':
        # Swap A and B in the mapping
        global ACTION_LETTERS
        ACTION_LETTERS = {
            'A': 2,  # view_02.png
            'B': 1,  # view_01.png
            'L': 0,  # no extra view / invalid fallback
...
def build_arg_parser():
    ...
    p.add_argument('--action-mapping', type=str, default='ab', choices=['ab', 'ba'], help='Mapping of action letters to views (Left-Right order) (default: ab)')
